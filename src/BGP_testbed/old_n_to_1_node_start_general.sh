...
#Prepare runing code
#echo "Start..."
#serverFile="testServer"
serverFile="server_general"
#clientFile="testClient"
clientFile="benchmark_client"
cp $serverFile /dev/shm/.
cp $clientFile /dev/shm/.
#cp file_400MB /dev/shm/.
cp torusIP /dev/shm/.
cp zht.cfg /dev/shm/.
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/$userName/Installed/built/lib
...
echo "$ip $port" >> /intrepid-fs0/users/$userName/persistent/neighbor_$numNode
sleep 10 # 3 for small, 10 for large
#echo "check neighbor list"
#numLine=`wc -l /intrepid-fs0/users/$userName/persistent/neighbor_$numNode | awk {'print $1'} `
...
svrIP=`head -1 /intrepid-fs0/users/$userName/persistent/neighbor_$numNode | awk {'print $1'}`
echo "$svrIP 50001" >> /dev/shm/neighbor_$numNode
#echo "$svrIP 50002" >> /dev/shm/neighbor_$numNode
#echo "$svrIP 50003" >> /dev/shm/neighbor_$numNode
#echo "$svrIP 50004" >> /dev/shm/neighbor_$numNode


#svrIP=`head -1 /dev/shm/neighbor_$numNode | awk {'print $1'}`

#echo "Time: neighbor list ready: `date`"

if [ $IP == $svrIP  ]; then
#	echo "server start at $IP"

	/dev/shm/$serverFile 50001 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg $protoc $userName &
#	/dev/shm/$serverFile 50002 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg $protoc $userName &
#	/dev/shm/$serverFile 50003 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg $protoc $userName &
#	/dev/shm/$serverFile 50004 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg $protoc $userName &
sleep 10 

#	/dev/shm/$clientFile 8000 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg $protoc &
#        /dev/shm/$clientFile 8000 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg $protoc &
#	/dev/shm/$clientFile 8000 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg $protoc &
#	/dev/shm/$clientFile 8000 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg $protoc &
#        /dev/shm/$clientFile 8000 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg $protoc &
...
#/dev/shm/client 10000 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg &
#/dev/shm/client 10000 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg &
#/dev/shm/client_general 1000 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg $TCP &
#/dev/shm/$clientFile 10000 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg & 

if [ $IP != $svrIP  ]; then
#	echo "client start at $IP"
#	/dev/shm/$clientFile 8000 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg $protoc &
#	/dev/shm/$clientFile 8000 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg $protoc &
#	/dev/shm/$clientFile 8000 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg $protoc &
	/dev/shm/$clientFile 8000 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg $protoc  #10240000
	sleep 1800
fi

#/dev/shm/$clientFile 10000 /dev/shm/neighbor_$numNode /dev/shm/zht.cfg $protoc
